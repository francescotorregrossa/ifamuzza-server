...
public abstract class PaymentMethod implements Validable, JsonPrivateSerialization {
  ...
  public PaymentMethod(JsonNode data) {
  ...
  public void setHolder(final String holder) { this.holder = holder.trim(); }

  public String getAddress() { return address; }
  public void setAddress(final String address) { this.address = address.trim(); }
